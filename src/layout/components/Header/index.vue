<template>
  <header class="header clfix" :class="{ active: headerActive }">
    <div class="left">
      <ul class="clfix">
        <li>
    ...
    <div class="right">
      <ul class="clfix">
        <li class="git">
          <a
            href="https://github.com/soheeyun831/bbosong-portfolio"
            target="_blank"
            aria-label="Github"
          >
            <svg
          ...
          >
            ...
            >
              <linearGradient
                ...
                y2="-84.047"
              >
                <stop offset="0" :stop-color="instagram ? '#fd5' : '#757474'" />
                <stop
                  offset=".5"
                  :stop-color="instagram ? '#ff543e' : '#757474'"
                />
                <stop
                  offset="1"
                  :stop-color="instagram ? '#c837ab' : '#757474'"
                />
              </linearGradient>
              <path
        ...
        <li class="kakao">
          <a
            href="https://open.kakao.com/o/sxEbGCac"
            target="_blank"
          ...
          >
            <svg
              ...
              xmlns="http://www.w3.org/2000/svg"
            >
              <path d="m9.462 9.306-.692 1.951h1.383z" fill="#757474" />
              <path
      ...
      li {
        ...
        a {
          ...
          &:after {
            ...
            content: "";
            position: absolute;
            border-bottom: solid 1px #df405a;
          }
